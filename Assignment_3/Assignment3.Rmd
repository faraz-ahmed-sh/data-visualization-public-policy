...
ggplot(data=summ_crimes_by_neighborhood, aes(x = Neighborhood, y= freq)) + 
  ...
  labs(title = "What Places in Lahore are Most Crime-Prone?", x = "Neighborhood", y = "Frequency of Crime Incidences", subtitle="Number of crime occurrences in   different neighborhoods in January 2015.", caption = "Source: Punjab Police Department") + t_title + t_axis + t_subtitle + 
